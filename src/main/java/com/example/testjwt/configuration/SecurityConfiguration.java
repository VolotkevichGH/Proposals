package com.example.testjwt.configuration;

import com.example.testjwt.security.UserDetailsServiceImpl;
import com.example.testjwt.security.jwt.JwtAuthenticationEntryPoint;
...
public class SecurityConfiguration {
    ...
    @Bean
    public AuthenticationManager dbAuthenticationManager(AuthenticationConfiguration authenticationConfiguration) throws Exception{
